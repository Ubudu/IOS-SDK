Pod::Spec.new do |s|
  s.name         = "UbuduSDK"
  s.version      = "1.25.0"
  s.summary      = "Add support of cloud-managed geofence and beacon proximity triggered interactions to IOS 10+ applications. Works with any iBeacon device."
  ...
  s.platform     = :ios, "10.0"
  s.source       = { :git => "https://github.com/Ubudu/IOS-SDK.git", :tag => "v1.25.0" }
